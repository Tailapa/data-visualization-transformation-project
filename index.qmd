...
2.  **The Median Gap:** Compared to the means, the medians are much closer (**`r med_dist_y` v/s `r med_dist_n`**) . This suggests that the "yes" group (those who tipped) mostly travelled long trips (outliers) that drives the average up.
